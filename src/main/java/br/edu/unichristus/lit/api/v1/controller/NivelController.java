...
public class NivelController  {
	...
	public ResponseEntity<CollectionModel<NivelModel>> listar(final ServletWebRequest request) {
		...
		final CollectionModel<NivelModel> niveisModel =
				this.nivelAssembler.toCollectionModel(todosNiveis);
	...
	public ResponseEntity<NivelModel> buscar(@PathVariable final Long nivelId,
            final ServletWebRequest request) {
		ShallowEtagHeaderFilter.disableContentCaching(request.getRequest());
		String eTag = "0";
		final OffsetDateTime dataAtualizacao = this.nivelRepository
				.getDataAtualizacaoById(nivelId);
	...
	public NivelModel atualizar(@PathVariable final Long nivelId,
			@RequestBody @Valid final NivelInput nivelInput) {
